...
impl HwpDocument {
    ...
    pub fn merge_table_cells_by_path(
        ...
        self.merge_table_cells_by_path_native(
            section_idx as usize,
            parent_para_idx as usize,
            path_json,
            start_row as u16,
    ...
    pub fn split_table_cell_by_path(
        ...
        self.split_table_cell_by_path_native(
            section_idx as usize,
            parent_para_idx as usize,
            path_json,
            row as u16,
    ...
    pub fn split_table_cell_into_by_path(
        ...
        self.split_table_cell_into_by_path_native(
            section_idx as usize,
            parent_para_idx as usize,
            path_json,
            row as u16,
    ...
    pub fn split_table_cells_in_range_by_path(
        ...
        self.split_table_cells_in_range_by_path_native(
            section_idx as usize,
            parent_para_idx as usize,
            path_json,
            start_row as u16,
    ...
    #[wasm_bindgen(js_name = deleteTableControlByPath)]
    pub fn delete_table_control_by_path(
        &mut self,
        section_idx: u32,
        parent_para_idx: u32,
        path_json: &str,
    ) -> Result<String, JsValue> {
        self.delete_table_control_by_path_native(
            section_idx as usize,
            parent_para_idx as usize,
            path_json,
        )
    ...
    #[wasm_bindgen(js_name = createTableInCellByPath)]
    pub fn create_table_in_cell_by_path(
        &mut self,
        section_idx: u32,
        parent_para_idx: u32,
        path_json: &str,
        ...
        self.create_table_in_cell_by_path_native(
            section_idx as usize,
            parent_para_idx as usize,
            path_json,
            char_offset as usize,
    ...
    #[wasm_bindgen(js_name = insertPictureInCellByPath)]
    pub fn insert_picture_in_cell_by_path(
        &mut self,
        section_idx: u32,
        parent_para_idx: u32,
        path_json: &str,
        ...
        self.insert_picture_in_cell_by_path_native(
            section_idx as usize,
            parent_para_idx as usize,
            path_json,
            char_offset as usize,
    ...
    #[wasm_bindgen(js_name = getPicturePropertiesByPath)]
    pub fn get_picture_properties_by_path(
        &self,
        section_idx: u32,
        parent_para_idx: u32,
        path_json: &str,
        ...
        self.get_picture_properties_by_path_native(
            section_idx as usize,
            parent_para_idx as usize,
            path_json,
            control_idx as usize,
    ...
    #[wasm_bindgen(js_name = setPicturePropertiesByPath)]
    pub fn set_picture_properties_by_path(
        &mut self,
        section_idx: u32,
        parent_para_idx: u32,
        path_json: &str,
        ...
        self.set_picture_properties_by_path_native(
            section_idx as usize,
            parent_para_idx as usize,
            path_json,
            control_idx as usize,
    ...
    #[wasm_bindgen(js_name = deletePictureControlByPath)]
    pub fn delete_picture_control_by_path(
        &mut self,
        section_idx: u32,
        parent_para_idx: u32,
        path_json: &str,
        ...
        self.delete_picture_control_by_path_native(
            section_idx as usize,
            parent_para_idx as usize,
            path_json,
            control_idx as usize,
    ...
    /// cellPath 기반으로 셀 내부 문단의 글자 속성을 조회한다.
    ...
    pub fn get_cell_char_properties_at_by_path(
        ...
        let path = DocumentCore::parse_cell_path(path_json)?;
        self.get_cell_char_properties_at_by_path_native(
            sec_idx,
            parent_para_idx,
            &path,
            char_offset,
    ...
    /// cellPath 기반으로 셀 내부 문단의 문단 속성을 조회한다.
    ...
    pub fn get_cell_para_properties_at_by_path(
        ...
        let path = DocumentCore::parse_cell_path(path_json)?;
        self.get_cell_para_properties_at_by_path_native(sec_idx, parent_para_idx, &path)
            .map_err(|e| e.into())
    }
    ...
    #[wasm_bindgen(js_name = evaluateTableFormulaByPath)]
    pub fn evaluate_table_formula_by_path(
        &mut self,
        section_idx: u32,
        parent_para_idx: u32,
        path_json: &str,
        ...
        self.core
            .evaluate_table_formula_by_path(
                section_idx as usize,
                parent_para_idx as usize,
                path_json,
                target_row as usize,
    ...
    /// cellPath 기반으로 셀 내부 문단에 글자 서식을 적용한다.
    ...
    /// cellPath 기반으로 셀 내부 문단에 문단 서식을 적용한다.
    ...
    pub fn apply_para_format_in_cell_by_path(
        ...
        let path = DocumentCore::parse_cell_path(path_json)?;
        self.apply_para_format_in_cell_by_path_native(sec_idx, parent_para_idx, &path, props_json)
            .map_err(|e| e.into())
    }
    ...
    #[wasm_bindgen(js_name = copyControlByPath)]
    pub fn copy_control_by_path(
        &mut self,
        section_idx: u32,
        parent_para_idx: u32,
        path_json: &str,
    ) -> Result<String, JsValue> {
        self.copy_control_by_path_native(section_idx as usize, parent_para_idx as usize, path_json)
            .map_err(|e| e.into())
    }
    ...
    #[wasm_bindgen(js_name = pasteControlInCellByPath)]
    pub fn paste_control_in_cell_by_path(
        &mut self,
        section_idx: u32,
        parent_para_idx: u32,
        path_json: &str,
        ...
        self.paste_control_in_cell_by_path_native(
            section_idx as usize,
            parent_para_idx as usize,
            path_json,
            char_offset as usize,
    ...
    #[wasm_bindgen(js_name = exportControlHtmlByPath)]
    pub fn export_control_html_by_path(
        &self,
        section_idx: u32,
        parent_para_idx: u32,
        path_json: &str,
    ) -> Result<String, JsValue> {
        self.export_control_html_by_path_native(
            section_idx as usize,
            parent_para_idx as usize,
            path_json,
        )
    ...
    /// cellPath 기반 컨트롤의 이미지 바이너리 데이터를 반환한다 (Uint8Array).
    #[wasm_bindgen(js_name = getControlImageDataByPath)]
    pub fn get_control_image_data_by_path(
        &self,
        section_idx: u32,
        parent_para_idx: u32,
        path_json: &str,
    ) -> Result<Vec<u8>, JsValue> {
        self.get_control_image_data_by_path_native(
            section_idx as usize,
            parent_para_idx as usize,
            path_json,
        )
    ...
    /// cellPath 기반 컨트롤의 이미지 MIME 타입을 반환한다.
    #[wasm_bindgen(js_name = getControlImageMimeByPath)]
    pub fn get_control_image_mime_by_path(
        &self,
        section_idx: u32,
        parent_para_idx: u32,
        path_json: &str,
    ) -> Result<String, JsValue> {
        self.get_control_image_mime_by_path_native(
            section_idx as usize,
            parent_para_idx as usize,
            path_json,
        )
    ...
    /// HTML 문자열을 파싱하여 cellPath가 가리키는 중첩 셀 내부 캐럿 위치에 삽입한다.
